...
* Learned the difference between independent and disjoint events and the formal definition of [independent events](https://en.wikipedia.org/wiki/Independence_(probability_theory)) in this [video](https://www.youtube.com/watch?v=w423ypsUHf0).
* Learned that if event A and B are independent, then A and the complement of B are also independent in this [video](https://www.youtube.com/watch?v=JZkT3NU2mPM).
...
* Still studying probability using this [probability course](https://www.edx.org/course/introduction-probability-part-1-mitx-6-041-1x) on [edX](https://www.edx.org/) plateform. Now i'm at the Unit 3 of the course (Conditioning and independence).
